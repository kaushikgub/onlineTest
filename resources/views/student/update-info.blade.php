...
<section class="container">
    <div>
        <h3 class="text-center mb-3 mt-3 text-primary font-italic"><u>Update Your Profile</u></h3>
    </div>
    {{ Form::open(array('url' => 'student/update-info','onsubmit' => 'return validation()','enctype'=>"multipart/form-data",'files' => true)) }}
    ...
    <div class="row border rounded p-2 border-info">
        <div class="col mr-1">
            ...
            <div class="row form-group border p-2 rounded bg-light">
                ...
                <div class="col-sm-8">
                    <input id="mobile" type="text" name="mobile" class="form-control" required pattern="[0-9]{10}">
                </div>
            </div>
            ...
            <div class="row form-group border p-2 rounded bg-light">
                ...
                <div class="col-sm-8">
                    <input id="alternate-no" type="text" name="alternate-no" class="form-control" pattern="[0-9]{10}">
                </div>
            </div>
